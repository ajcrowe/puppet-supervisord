...
class supervisord (
  ...
  Supervisord::Maxbytes $logfile_maxbytes                                           = $supervisord::params::logfile_maxbytes,
  ...
  Supervisord::Umask $umask                                                         = $supervisord::params::umask,
  ...
  if $environment {
    notify { '[supervisord] *** DEPRECATED WARNING ***: $global_environment has replaced $environment': }
  }
